#!/usr/bin/env bash
# 
# eoneil: TPCB script, 3 host case, Voltdb or CVoltdb
...
SERVERS="192.168.2.222,192.168.2.221,192.168.2.223"
BRANCHES=12
...
function server() {
    ...
    $VOLTDB create catalog $APPNAME.jar deployment mh3_deployment.xml \
