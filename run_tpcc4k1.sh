...
SERVERS="192.168.2.222,192.168.2.221,192.168.2.223,192.168.2.224"
WAREHOUSES=12
...
function server() {
    ...
    # run the server
    $VOLTDB create -d mh4_deploymentk1.xml -l $LICENSE -H $LEADER $APPNAME.jar 
}
...
function help() {
    echo "Usage: ./run_tpcc2.sh voltrootdir {clean|catalog-v|catalog-cv|server|server-ea|client|client-ea}"
}
